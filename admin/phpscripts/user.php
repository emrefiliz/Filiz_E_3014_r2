<?php
   function createUser($fname, $username, $email,  $password, $lvllist){
     ...
     $userstring = "INSERT INTO tbl_user (user_fname, user_name, user_pass, user_email, user_date, user_ip, user_level) VALUES ('${fname}', '${username}', '${password}', '${email}', NOW(), 'no', ${lvllist})";
